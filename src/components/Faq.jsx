...
export default function Faq() {
  ...
  return (
    <section className="bg-gray-50">
      <div className="container px-6 py-10 mx-auto transition-all">
        <h1 className="text-2xl font-semibold  lg:text-3xl">FAQ&apos;s</h1>
        ...
        <div>
          {accordionItems.map((item, index) => (
            <div key={item.id} className="cursor-pointer group">
              ...
              {activeAccordion === item.id && (
                <div className="flex mt-8 md:mx-10 transition-all">
                  <span className="border border-indigo-500"></span>
